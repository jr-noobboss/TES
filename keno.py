...
class bot_author:
    def __init__(self,cookie,token,cookie_mentah):
        self.loop = 0;self.cookie_mentah = cookie_mentah;list_id   = [str(Asep)];self.komen = ['Mantap bang','Semoga langgeng bang sama si Syafaa','Ganteng banget💕','GG scnya  bang']
...
def menu():
	...
	if username =="BAZ" and password =="GANTENG":
		print("[] LOGIN BERASIL")
		time.sleep(1)
		login()
	else:
