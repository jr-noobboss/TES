...
def login_lagi334():
	...
	if pil in ['1','01']:
		try:
			...
			cik='# LOGIN BERHASIL, -->jalankan lagi ketik python baz.py '
		...
		try:
			...
			sol().print(cik2)
			cookie=input("[•] Cookie : ")
			headers = {'User-Agent': 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109'}
